...
#if 0
INLINE void *real_tls_get_addr(size_t tls_ia64_m, size_t tls_ia64_offset) {
  void *(*dlsym_tls_get_addr)(size_t tls_ia64_m, size_t tls_ia64_offset);
  dlsym_tls_get_addr = (void *(*)(size_t tls_ia64_m, size_t tls_ia64_offset))dltrans("__tls_get_addr");
  void *ret = dlsym_tls_get_addr(tls_ia64_m, tls_ia64_offset);
  return ret;
}
#else
INLINE void *real_tls_get_addr(void *a) {
  void *(*dlsym_tls_get_addr)(void *a);
  dlsym_tls_get_addr = (void *(*)(void *a))dltrans("__tls_get_addr");
  void *ret = dlsym_tls_get_addr(a);
  return ret;
}
#endif
